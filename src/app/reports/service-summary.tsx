...
const styles = StyleSheet.create({
  ...
  serviceName: { fontSize: 14, fontWeight: '700', color: '#1A1D21' },
  serviceRevenue: { fontSize: 14, fontWeight: '800', color: '#1A1D21' },
  barTrack: { height: 8, backgroundColor: '#F7F8FA', borderRadius: 4, overflow: 'hidden', marginBottom: 8 },
  barFill: { height: '100%', backgroundColor: '#2563EB', borderRadius: 4 },
  serviceMetaRow: { flexDirection: 'row', justifyContent: 'space-between' },
  serviceMetaText: { fontSize: 11, color: '#6B7280' },
});