...
const styles = StyleSheet.create({
  ...
  summaryLabel: { color: '#C7D9FB', fontSize: 12, fontWeight: '600', marginBottom: 6 },
  ...
  breakdownName: { flex: 1, fontSize: 13, fontWeight: '600', color: '#1A1D21' },
  breakdownCount: { fontSize: 12, color: '#6B7280', marginRight: 12 },
  breakdownTotal: { fontSize: 13, fontWeight: '800', color: '#1A1D21' },
  txnCard: {
    backgroundColor: '#FFFFFF',
    borderRadius: 14,
    padding: 14,
